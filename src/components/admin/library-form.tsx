    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      <Card>
        ...
        <CardContent className="grid gap-6 md:grid-cols-2">
          ...
          <FormFieldShell
            ...
            label="收录日期"
          >
            <Input id="library-added-at" type="date" {...register("addedAt")} />
          </FormFieldShell>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <FormFieldShell error={errors.source?.message} label="源码开放程度">
            <Controller
              control={control}
              name="source"
              render={({ field }) => (
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-6">
          <FormFieldShell error={errors.deliveries?.message} label="交付类型">
            <Controller
              control={control}
              name="deliveries"
              render={({ field }) => (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>用于前台搜索和筛选的自由文本标签。</CardDescription>
        </CardHeader>
        <CardContent>
